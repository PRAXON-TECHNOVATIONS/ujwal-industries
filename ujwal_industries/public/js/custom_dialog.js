...
frappe.ui.CustomDialog = class CustomDialog extends frappe.ui.FieldGroup {
	constructor(opts) {
		super();
		this.display = false;
		this.is_dialog = true;
	...
	make() {
		...
		else if (this.size == "super-large") $(this.wrapper).addClass("modal-2xl");
		...
		// Custom classes for rich glassmorphism styling
		if (this.size === 'super-large') {
			$(this.header).addClass('cd-modal-header');
			$(this.footer).addClass('cd-modal-footer');
			$(this.modal_body).addClass('cd-modal-body');
		}
